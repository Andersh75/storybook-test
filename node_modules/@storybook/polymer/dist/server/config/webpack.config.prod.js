...
exports.default = function (configDir) {
  ...
  var config = {
    ...
    }), new _copyWebpackPlugin2.default([{ from: require.resolve('@webcomponents/webcomponentsjs/webcomponents-lite.js') }, { from: require.resolve('@webcomponents/webcomponentsjs/custom-elements-es5-adapter.js') }]), new _webpack2.default.DefinePlugin((0, _utils.loadEnv)({ production: true })), new _uglifyjsWebpackPlugin2.default({
      parallel: true,
      uglifyOptions: {
        ie8: false,
        mangle: false,
